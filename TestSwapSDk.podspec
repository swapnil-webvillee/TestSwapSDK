...
Pod::Spec.new do |s|
  ...
  s.name         = "TestSwapSDk"
  s.version      = "1.0.0"
  s.summary      = "A short description of TestSwapSDk."
  ...
  s.homepage     = "http://EXAMPLE/TestSwapSDk"
  ...
  s.source       = { :git => "https://github.com/swapnil-webvillee/TestSwapSDK.git", :tag => "1.0.0" }
